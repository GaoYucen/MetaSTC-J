"""J2 minimal FiLM integration of the frozen V14 residual adapter.

Generated by an authorized mechanical transfer: only the frozen base expert
class/checkpoint family changes from LSTMModel to FiLMModel. The adapter, data
split, horizon, metrics, and validation-selection logic are unchanged.
"""
...
from optimized_runner import FiLMModel, _load_flow, _metrics, _set_seed, _windows
...
def main():
    ...
    ap.add_argument("--checkpoint-dir",default="param/4090_tuned/film/beijing")
    ap.add_argument("--output-dir",default="outputs/j2_film/j2_01_smoke")
    ...
    result={"experiment":"dynamic_residual_meta_adapter_film_v14","dataset":args.dataset,"protocol":"J2 correctness smoke; paper-style 80/20 temporal split, L=12, P=6; frozen 4090-tuned MetaSTC+FiLM cluster experts","config":vars(args),"paper_target_l12":paper_targets[args.dataset],"reproduced_static_reference":{"MAE":initial["static"]["MAE"],"MSE":initial["static"]["MSE"]},"initial_test":initial,"validation":validation,"test":test,"history":history}
